...
accuracy = my_accuracy(tf_matrix_output, tf_matrix_label)

y = []
x = []
with tf.Session() as sess:
    sess.run(tf.global_variables_initializer())
    res = sess.run([accuracy], feed_dict={tf_matrix_label:matrix_label, tf_matrix_output:matrix_output})
